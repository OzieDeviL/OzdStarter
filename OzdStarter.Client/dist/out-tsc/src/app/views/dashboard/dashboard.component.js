...
var _1 = require("@coreui/coreui/js/src/utilities/");
var _2 = require("@coreui/coreui-plugin-chartjs-custom-tooltips/js/");
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent() {
        ...
        this.lineChart1Colours = [
            {
                backgroundColor: _1.getStyle('--primary'),
        ...
        this.lineChart2Colours = [
            {
                backgroundColor: _1.getStyle('--info'),
                borderColor: 'rgba(255,255,255,.55)'
            }
        ];
        ...
        this.mainChartColours = [
            {
                backgroundColor: _1.hexToRgba(_1.getStyle('--info'), 10),
                borderColor: _1.getStyle('--info'),
                pointHoverBackgroundColor: '#fff'
            },
            {
                backgroundColor: 'transparent',
                borderColor: _1.getStyle('--success'),
                pointHoverBackgroundColor: '#fff'
            },
            {
                backgroundColor: 'transparent',
                borderColor: _1.getStyle('--danger'),
                pointHoverBackgroundColor: '#fff',
                borderWidth: 1,
                borderDash: [8, 5]
            }
